...
if($_REQUEST['Log_In'])
{
	if (file_exists("Userdata/$User_Name") && file_exists("Userdata/$User_Name/User_Info/Encrypted/Password/$Password"))
	{
		...
		{
			$Msg= "The email address or password is incorrect.<br /> Please try again. ShopCircle passwords are<br /> case sensitive (check your CAPS lock key).<br /><br /> <a href='Index.php?goto=Reset_Password' style='text-decoration:none' >You can reset your password here.</a><br />";
			}
	}
...
if($_REQUEST['Sign_Up'])
{
	...
	elseif (file_exists("Userdata/$User_Name") or file_exists("Userdata/Check_UserName_Email_PhNo/Email_ID/$Email") or file_exists("Userdata/Check_UserName_Email_PhNo/Mobile_No/$Mobile_No") or file_exists("Userdata/Check_UserName_Email_PhNo/User_Name/$User_Name"))
	{
		...
		else
		{
			...
			$Msg_Sign_Up= "<b>Welcome to <font color='#0065CA'>ShopRun</font><font color='#F87217'> $First_Name $Last_Name !!</font></b>";
...
<td align="center" width="465px" height="480px"><center><form method="post">
<table border="0">
...
<a href="Index.php?goto=Sign_Up" style="text-decoration:none;" ><input type="button" style="background-color:<?php echo "#".$mButton_Color;?>; color:<?php echo "#".$mFont_Color;?>; font-size:14px;font-weight:600" name="Sign_Up" value="Sign Up" /></a></td></tr>
...
<tr><td>Don't have a <strong style="color:<?php echo "#".$mButton_Color;?>">ShopCircle</strong> account?<a href="Index.php?goto=Sign_Up" style="text-decoration:none;" ><strong> Sign up now </strong></a></td></tr>
