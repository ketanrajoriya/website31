...
if($Reset_mButton)
{
	unlink("Userdata/Theme/mbuttoncolor");
	}
	if($Reset_mBackground)
{
	unlink("Userdata/Theme/mbgcolor");
	}
	if($Reset_mFont)
{
	unlink("Userdata/Theme/mfontcolor");
	}
?>
...
if($goto_mbgcolor)
{
	$mTheme_Location=fopen("Userdata/Theme/mbgcolor","w");
...
{
	$mTheme_Location=fopen("Userdata/Theme/mbuttoncolor","w");
...
if($goto_mfontcolor)
{
	$mTheme_Location=fopen("Userdata/Theme/mfontcolor","w");
...
<tr height="480px"><td colspan="3" align="right" width="1000px" height="480px">
	
<table width="100%" border="0">
<tr><a href="Index.php"><input type="button" value="Home" style="background-color:<?php echo "#".$mButton_Color;?>; color:<?php echo "#".$mFont_Color;?>; font-size:12px; font-weight:600; margin-right:30px"/></a><td><hr />
<font style="font-family:Verdana, Geneva, sans-serif; font-size:18px; font-weight:500">Background Colors <input type="submit" value="Reset" name="Reset_mBackground" style="background-color:<?php echo "#".$mButton_Color;?>; color:<?php echo "#".$mFont_Color;?>; font-size:12px; font-weight:600; margin-right:30px"/><hr />
</font></td></tr>
...
foreach($mColors_Array as $mColor_Name=>$mColor)
{
	$i==1;
	$i++;
	$mecho_BG_Array="<a href='MChange_Themes.php?goto_mbgcolor=$mColor'><input type='button' value='&nbsp;&nbsp;&nbsp;$i&nbsp;&nbsp;&nbsp;' style='background-color:#$mColor; color:#FFFFFF; font-size:12px; font-weight:600'/></a>";
	echo $mecho_BG_Array;
	}
?>
</td></tr>
...
<tr><td><hr />
<font style="font-family:Verdana, Geneva, sans-serif; font-size:18px; font-weight:500">Button Colors <input type="submit" value="Reset" name="Reset_mButton" style="background-color:<?php echo "#".$mButton_Color;?>; color:<?php echo "#".$mFont_Color;?>; font-size:12px; font-weight:600; margin-right:30px" /><hr /></font></td></tr>
...
foreach($mColors_Array as $mColor_Name=>$mColor)
{
	$j==1;
	$j++;
	$mecho_BG_Array="<a href='MChange_Themes.php?goto_mbuttoncolor=$mColor'><input type='button' value='&nbsp;&nbsp;&nbsp;$j&nbsp;&nbsp;&nbsp;' style='background-color:#$mColor; color:#FFFFFF; font-size:12px; font-weight:600'/></a>";
	echo $mecho_BG_Array;
	}
?>
</td></tr>
...
<input type="submit" value="Reset" name="Reset_mFont" style="background-color:<?php echo "#".$mButton_Color;?>; color:<?php echo "#".$mFont_Color;?>; font-size:12px; font-weight:600; margin-right:30px"/><hr /></font></td></tr>
...
foreach($mColors_Array as $mColor_Name=>$mColor)
{
	$k==1;
	$k++;
	$mecho_BG_Array="<a href='MChange_Themes.php?goto_mfontcolor=$mColor'><input type='button' value='&nbsp;&nbsp;&nbsp;$k&nbsp;&nbsp;&nbsp;' style='background-color:#$mColor; color:#FFFFFF; font-size:12px; font-weight:600'/></a>";
	echo $mecho_BG_Array;
	}
?>
</td></tr>
...
<?php include("Include_Main2.php");?>  </table>
</form>
