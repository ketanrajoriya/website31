...
if($_REQUEST['rset'])
{
	$newregno=$_REQUEST['newreg'];
//echo "you entered $newregno";
	$sql1="update doctor set number='$newregno'  where emailid='$ketan'";
	$qr1=mysql_query($sql1);
	//echo "you entered $qr1";
	
	echo "regitration number updated";
	}
...
if($_REQUEST['emailset'])
{
	...
	$sql1="update doctor set emailid='$email' where emailid='$ketan'";
	$qr1=mysql_query($sql1);
	$sql2="update doctorpatient set doctoremailid='$email' where doctoremailid='$ketan'";
...
$newpass=$_REQUEST['newpass'];
	...
	$sql1="update doctor set password='$newpass' where emailid='$ketan'";
	$qr1=mysql_query($sql1);
...
//echo "you entered $newregno";
	$sql1="update doctor set skypeid='$newskype'  where emailid='$ketan'";
	$qr1=mysql_query($sql1);
	echo "you entered $qr1";
...
if($_REQUEST['mset'])
{
	...
	$sql1="update doctor set mobileno='$newmobileno'  where emailid='$ketan'";
	$qr1=mysql_query($sql1);
	...
	if($_REQUEST['dateset'])
{
	...
	$sql1="update doctor set dateofbirth='$newdate' where emailid='$ketan'";
	$qr1=mysql_query($sql1);
...
<tr><td align="left" style="font:Verdana, Geneva, sans-serif; color:FF3F00; font-weight:700; font-size:20px"> Update registration number</td></tr>
<form>

<tr>
  <td align="right"><input type="text" name="newreg" placeholder=" new regestraion number">
<input type="submit" name="rset" value="Submit" style="font:Verdana, Geneva, sans-serif; font-size:15px; border-bottom-style:solid;border-color:#FF9933; width:90px; height:22px; background-color:#CCC; color:#000"><br>
...
<img src="VR2.jpg" width="560px" align="right"></td></
