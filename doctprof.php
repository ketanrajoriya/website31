...
if($add)
{
	$_SESSION['pate']=$pat;
$_SESSION['docte']=$uid;
header("location:assigndoct.php");
...
<form>
<input type="submit" name="add" value="Get Appointment" style="font:Verdana, Geneva, sans-serif; font-size:18px; border-bottom-style:solid;border-color:#FF9933; width:190px; height:30px; background-color:#CCC; color:#F00; border-top-style:solid; border-left-style:solid;"/></form>
</td></tr></table>
</body>
</html>
