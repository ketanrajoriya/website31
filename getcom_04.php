...
if(isset($_POST['submit'])){
    ...
    if($comment != '')
    {
        $query = mysql_query("insert into response (comment , time, topic_no) values ('$comment', NOW() ,'4')", $connection);
        echo "<script type='text/javascript'>alert('Response recorded..Thanks!!!'); window.open('disc_04.php','_self');</script>";
