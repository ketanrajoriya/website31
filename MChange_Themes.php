...
<tr><a href="Index.php">
<input type="button" value="Home" style="background-color:<?php echo "#".$mButton_Color;?>; color:<?php echo "#".$mFont_Color;?>; font-size:12px; font-weight:600; margin-right:30px"/></a><td><hr />
