...
if(isset($_POST['submit'])){
    ...
    if($comment != '')
    {
        $query = mysql_query("insert into response (comment , time, topic_no) values ('$comment', NOW() ,'2')", $connection);
        echo "<script type='text/javascript'>alert('Response recorded..Thanks!!!'); window.open('disc_02.php','_self');</script>";
